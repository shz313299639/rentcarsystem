...
%>
                ...
                <FORM id="regform" name="regform" action="<%=basePath%>Member.do?method=PREG" method="post">
                  <TABLE cellSpacing=0 cellPadding=0 width=100% bgColor=#f5f5f5 border=0>
                    ...
                    <TR>
					  ...
					  <SPAN class=black><FONT color=blue><strong>注册信息: </strong></FONT>　　　　　　　　　　 
         ...
         <TABLE  height=237 cellSpacing=0  cellPadding=0 width="100%" border=0 hspace="12">
                          <TBODY>
                          <TR e>
                            <TD vAlign=center align=right  height=12>登 录 名：</TD>
						  ...
						  <TR >
						    <TD vAlign=center align=right  height=26>&nbsp;&nbsp;年龄：</TD>
						    <TD width=556 height=26 align=left>
						    <INPUT class=inputb maxLength=24 size=15 name=bir ></TD>
						  </TR>
                          <TR >
                          ...
                          <TR >
                            <TD vAlign=center align=right  height=12>所在省市：</TD>
