...
function bjump(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="<%=basePath%>admin/prep/tj.jsp?page="+pageCount;
		form3.submit();
	}
}
...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
    ...
    <%cb.setEVERYPAGENUM(12); double fff=0;
	...
	double fyzj=Float.parseFloat(cb.getString("select  zj from qc where id='"+pagelist2.get(1).toString()+"'"))*f*days;
	NumberFormat nf=new DecimalFormat( "###0.00 ");
	String zje=nf.format(fyzj)	;
    fff+=fyzj;
	  %>
...
String fff1=nf1.format(fff)	;  %>

      <td align="center" colspan=10>总计：<%=fff1 %> 元</td>  
    </tr>
 <tr bgcolor='#FFFFFF'>
