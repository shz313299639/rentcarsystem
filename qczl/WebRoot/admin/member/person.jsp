	...
	function allch()
	{
		for(i=0;i<<%=pagelist3.size()%>;i++)
		{
		  ...
		  <TR align="center" bgColor=#ffffff>
			...
			<TD id=map><%=cb.getCount("select jf from member where username='"+pagelist2.get(1).toString()+"'") %></TD>
			<TD id=map>
			
			
			<%
			String str="普通会员，享受9.8折优惠";int num=cb.getCount("select jf from member where username='"+pagelist2.get(1).toString()+"'");
