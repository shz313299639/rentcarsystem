	...
	<form action="<%=basePath %>Member.do?method=UPREGINFO" method="post" name="regform" onSubmit="return checkpersonreg()">
       <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		  ...
		  <TR align="center" bgColor=#ffffff>
			...
			<INPUT class=inputb maxLength=24 size=15 name=realname value=<%=list.get(1).toString() %>> <FONT color=#ff0000>**</FONT>
			</TD>
		  </TR>
		  <TR align="center" bgColor=#ffffff>
			<TD width="30%" align="right" >年龄：</TD>
			<TD width="70%" align="left" id=map>
			<INPUT class=inputb maxLength=24 size=10 name=bir value="<%=list.get(3).toString() %>" >  
			</TD>
		  </TR>
		  <TR align="center" bgColor=#ffffff>
		  ...
		  <TR align="center" bgColor=#ffffff>
			...
			<TD width="70%" align="left" id=map>
			<INPUT class=inputb maxLength=28 size=30  name=address value="<%=list.get(10).toString() %>"> <FONT color=#ff0000>**</FONT> 
			</TD>
		  </TR> 
		  <TR align="center" bgColor=#ffffff>
